  ...
  recognition.onresult = async function (event) {
    ...
    if (newTranscript.includes('Jarvis')) {
      ...
      if (
        ...
        turnLightOff();
        speak({
          text: 'I turned the lights off sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'I turned the lights on sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'Your lights are now red sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'Your lights are now green sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        turnLightOn(133, 1, 250);
        speak({
          text: 'Your lights are now white sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'Your lights are now blue sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'Your lights are now purple sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
        ...
        speak({
          text: 'Your lights are now pink sir',
          voice: voices[15],
          rate: 0.85,
        });
        return;
